                ...
                <Row>
                    ...
                    <Col>{vote.includes(dataPost.id) ? (
                        <button className="close-detail-button" style={{ backgroundImage: 'linear-gradient(180deg, hsl(131deg 93% 48%) 0%, hsl(168deg 55% 42%) 100%)' }}>
                            <span className="text" onClick={() => handleUnVote(dataPost.id)} style={{ backgroundImage: 'linear-gradient(180deg, hsl(131deg 93% 48%) 0%, hsl(168deg 55% 42%) 100%)' }}>Voted <i className="icofont-check"></i></span>
                        </button>) :
                        (
                            <button className="close-detail-button" style={{}}>
                                <span className="text" onClick={() => handleVote(dataPost.id)} ><i className="icofont-bubble-up"></i> Vote</span>
                            </button>
                        )
                    }</Col>
                </Row>
